...
DEVICE_DIR="/data/local/tmp/preserve_18281FDF6007HB_20260701_215952_3652903_845197349"
PID_FILE="/data/local/tmp/preserve_18281FDF6007HB_20260701_215952_3652903_845197349/pid"
OUT="./preserve_40apps_tombstone"
STOP_COMMAND="pkill -f 'adb_dexopt_regen_loop.sh|adb_oat_rewrite_capture.sh'"
shell_quote() {
  printf "'"
  printf '%s' "$1" | sed "s/'/'\\\\''/g"
  printf "'"
